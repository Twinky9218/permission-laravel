            ...
            $table->string('user_reference_number',20)->nullable(false);
            ...
            $table->enum('quickloan_txn_status',['INITIATE','CA','NOT_ELIGIBLE','ELIGIBLE','ONGOING_NOT_ELIGIBLE_FOR_REPEAT',
            'ONGOING_ELIGIBLE_FOR_REPEAT']);
          ...
          $table->enum('collection_payment_campaign',['SNOOZE','DUES_WAVIER','EMI_HOLIDAY','SETTLEMENT','RESTRUCTING','MULTI']);
            ...
            $table->enum('language_preference',['ENGLISH','HINDI','MARATHI','GUJARATI','TAMIL','TELUGU','KANNADA','BENGALI',
            'ODIA','MALAYALAM','PUNJABI','ASSAMESE','URDU']);   
